...
export default function UniversalWallet({ wallet }: { wallet: Wallet }) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="space-y-4 text-white w-full sm:w-4/5">
        <div className="flex justify-between">
          <span className="font-medium">Total Added Funds</span>
          <span className="text-green-600">₹{wallet.addFund.toFixed(2)}</span>
        </div>
        <div className="flex justify-between">
          <span className="font-medium">Total Withdrawal Funds</span>
